...
// MsgInv implements the Message interface and represents a Utopia inv message.
...
// NewMsgInv returns a new Utopia inv message that conforms to the Message
...
// NewMsgInvSizeHint returns a new Utopia inv message that conforms to the
