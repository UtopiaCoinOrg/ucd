...
const DefaultUserAgent = "/ucwire:0.3.0/"

// MsgVersion implements the Message interface and represents a Utopia version
...
// NewMsgVersion returns a new Utopia version message that conforms to the
...
// and local address from conn and returns a new Utopia version message that
