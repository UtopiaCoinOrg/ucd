...
// MsgBlock implements the Message interface and represents a utopia
...
// BtcDecode decodes from the Utopia wire protocol as it was sent across the
...
// the Utopia wire protocol in order to be sent across the network.  The wire
...
// NewMsgBlock returns a new Utopia block message that conforms to the
