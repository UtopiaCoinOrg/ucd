...
// MsgGetData implements the Message interface and represents a utopia
...
// NewMsgGetData returns a new Utopia getdata message that conforms to the
...
// NewMsgGetDataSizeHint returns a new Utopia getdata message that conforms to
