...
// MsgMemPool implements the Message interface and represents a Utopia mempool
...
// NewMsgMemPool returns a new Utopia pong message that conforms to the Message
