...
// MsgReject implements the Message interface and represents a Utopia reject
// message.
//
...
func (msg *MsgReject) MaxPayloadLength(pver uint32) uint32 {
	// Unfortunately the Utopia protocol does not enforce a sane
...
// NewMsgReject returns a new Utopia reject message that conforms to the
