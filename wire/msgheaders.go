...
// a single Utopia headers message.
const MaxBlockHeadersPerMsg = 2000

// MsgHeaders implements the Message interface and represents a Utopia headers
...
// NewMsgHeaders returns a new Utopia headers message that conforms to the
