...
// maxNetAddressPayload returns the max payload size for a Utopia NetAddress
...
type NetAddress struct {
	...
	// not present in the Utopia version message (MsgVersion) nor was it
...
func readNetAddress(r io.Reader, pver uint32, na *NetAddress, ts bool) error {
	...
	// NOTE: The Utopia protocol uses a uint32 for the timestamp so it will
	...
	// Sigh.  Utopia protocol mixes little and big endian.
