...
func (c *Client) SubmitBlockAsync(block *ucutil.Block, options *chainjson.SubmitBlockOptions) FutureSubmitBlockResult {
	blockHex := ""
	if block != nil {
...
// SubmitBlock attempts to submit a new block into the Utopia network.
func (c *Client) SubmitBlock(block *ucutil.Block, options *chainjson.SubmitBlockOptions) error {
