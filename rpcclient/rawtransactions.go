...
func (r FutureGetRawTransactionResult) Receive() (*ucutil.Tx, error) {
...
func (c *Client) GetRawTransactionAsync(txHash *chainhash.Hash) FutureGetRawTransactionResult {
	...
	cmd := chainjson.NewGetRawTransactionCmd(hash, ucjson.Int(0))
...
// transaction.
func (c *Client) GetRawTransaction(txHash *chainhash.Hash) (*ucutil.Tx, error) {
...
func (c *Client) GetRawTransactionVerboseAsync(txHash *chainhash.Hash) FutureGetRawTransactionVerboseResult {
	...
	cmd := chainjson.NewGetRawTransactionCmd(hash, ucjson.Int(1))
	return c.sendCmd(cmd)
}
...
func (c *Client) CreateRawTransactionAsync(inputs []chainjson.TransactionInput,
	amounts map[ucutil.Address]ucutil.Amount, lockTime *int64, expiry *int64) FutureCreateRawTransactionResult {
...
func (c *Client) CreateRawTransaction(inputs []chainjson.TransactionInput,
	amounts map[ucutil.Address]ucutil.Amount, lockTime *int64, expiry *int64) (*wire.MsgTx, error) {
...
type SStxCommitOut struct {
	Addr       ucutil.Address
	CommitAmt  ucutil.Amount
	ChangeAddr ucutil.Address
	ChangeAmt  ucutil.Amount
}
...
func (c *Client) CreateRawSStxAsync(inputs []chainjson.SStxInput,
	amount map[ucutil.Address]ucutil.Amount,
...
func (c *Client) CreateRawSSRtxAsync(inputs []chainjson.TransactionInput, fee ucutil.Amount) FutureCreateRawSSRtxResult {
	feeF64 := fee.ToCoin()
...
func (c *Client) CreateRawSSRtx(inputs []chainjson.TransactionInput, fee ucutil.Amount) (*wire.MsgTx, error) {
...
func (c *Client) SearchRawTransactions(address ucutil.Address, skip, count int,
...
func (c *Client) SearchRawTransactionsVerboseAsync(address ucutil.Address, skip,
...
func (c *Client) SearchRawTransactionsVerbose(address ucutil.Address, skip,
	count int, includePrevOut bool, reverse bool,
