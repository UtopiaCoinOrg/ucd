...
func (c *Client) ListUnspentMinMaxAddressesAsync(minConf, maxConf int, addrs []ucutil.Address) FutureListUnspentResult {
...
func (c *Client) ListUnspentMinMaxAddresses(minConf, maxConf int, addrs []ucutil.Address) ([]walletjson.ListUnspentResult, error) {
...
func (c *Client) ListSinceBlockAsync(blockHash *chainhash.Hash) FutureListSinceBlockResult {
	var hash *string
	if blockHash != nil {
		hash = ucjson.String(blockHash.String())
	}
...
func (r FutureListLockUnspentResult) Receive() ([]*wire.OutPoint, error) {
	...
	for i, input := range inputs {
		...
		ops[i] = wire.NewOutPoint(sha, input.Vout, input.Tree) // Utopia TODO
	}
...
func (c *Client) SendToAddressAsync(address ucutil.Address, amount ucutil.Amount) FutureSendToAddressResult {
...
func (c *Client) SendToAddress(address ucutil.Address, amount ucutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendToAddressCommentAsync(address ucutil.Address,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendToAddressComment(address ucutil.Address, amount ucutil.Amount, comment, commentTo string) (*chainhash.Hash, error) {
...
func (c *Client) SendFromAsync(fromAccount string, toAddress ucutil.Address, amount ucutil.Amount) FutureSendFromResult {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFrom(fromAccount string, toAddress ucutil.Address, amount ucutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendFromMinConfAsync(fromAccount string, toAddress ucutil.Address, amount ucutil.Amount, minConfirms int) FutureSendFromResult {
	addr := toAddress.Address()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromMinConf(fromAccount string, toAddress ucutil.Address, amount ucutil.Amount, minConfirms int) (*chainhash.Hash, error) {
...
func (c *Client) SendFromCommentAsync(fromAccount string,
	toAddress ucutil.Address, amount ucutil.Amount, minConfirms int,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromComment(fromAccount string, toAddress ucutil.Address,
	amount ucutil.Amount, minConfirms int,
...
func (c *Client) SendManyAsync(fromAccount string, amounts map[ucutil.Address]ucutil.Amount) FutureSendManyResult {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendMany(fromAccount string, amounts map[ucutil.Address]ucutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendManyMinConfAsync(fromAccount string,
	amounts map[ucutil.Address]ucutil.Amount,
...
func (c *Client) SendManyCommentAsync(fromAccount string,
	amounts map[ucutil.Address]ucutil.Amount, minConfirms int,
...
func (c *Client) PurchaseTicketAsync(fromAccount string,
	spendLimit ucutil.Amount, minConf *int, ticketAddress ucutil.Address,
	numTickets *int, poolAddress ucutil.Address, poolFees *ucutil.Amount,
	expiry *int, ticketFee *ucutil.Amount) FuturePurchaseTicketResult {
	...
	cmd := walletjson.NewPurchaseTicketCmd(fromAccount, spendLimit.ToCoin(),
		...
		&poolFeesFloat, &expiryVal, ucjson.String(""), &ticketFeeFloat)
...
func (c *Client) PurchaseTicket(fromAccount string,
	spendLimit ucutil.Amount, minConf *int, ticketAddress ucutil.Address,
	numTickets *int, poolAddress ucutil.Address, poolFees *ucutil.Amount,
	expiry *int, ticketChange *bool, ticketFee *ucutil.Amount) ([]*chainhash.Hash, error) {
...
func (r FutureAddMultisigAddressResult) Receive() (ucutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) AddMultisigAddressAsync(requiredSigs int, addresses []ucutil.Address, account string) FutureAddMultisigAddressResult {
...
func (c *Client) AddMultisigAddress(requiredSigs int, addresses []ucutil.Address, account string) (ucutil.Address, error) {
...
func (c *Client) CreateMultisigAsync(requiredSigs int, addresses []ucutil.Address) FutureCreateMultisigResult {
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.String())
	}
...
// multisignature address and script needed to redeem it.
func (c *Client) CreateMultisig(requiredSigs int, addresses []ucutil.Address) (*walletjson.CreateMultiSigResult, error) {
...
// address.
func (r FutureGetNewAddressResult) Receive() (ucutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetNewAddress(account string) (ucutil.Address, error) {
...
func (c *Client) GetNewAddressGapPolicy(account string, gapPolicy GapPolicy) (ucutil.Address, error) {
...
func (r FutureGetRawChangeAddressResult) Receive() (ucutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetRawChangeAddress(account string) (ucutil.Address, error) {
...
// Utopia address for receiving payments to the specified account.
func (r FutureGetAccountAddressResult) Receive() (ucutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
// GetAccountAddress returns the current Utopia address for receiving payments
// to the specified account.
func (c *Client) GetAccountAddress(account string) (ucutil.Address, error) {
...
func (c *Client) GetAccountAsync(address ucutil.Address) FutureGetAccountResult {
	addr := address.Address()
...
func (c *Client) GetAccount(address ucutil.Address) (string, error) {
...
func (r FutureGetAddressesByAccountResult) Receive() ([]ucutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
// passed account.
func (c *Client) GetAddressesByAccount(account string) ([]ucutil.Address, error) {
...
// about the given Utopia address.
...
func (c *Client) ValidateAddressAsync(address ucutil.Address) FutureValidateAddressResult {
	addr := address.Address()
	cmd := chainjson.NewValidateAddressCmd(addr)
	return c.sendCmd(cmd)
}

// ValidateAddress returns information about the given Utopia address.
func (c *Client) ValidateAddress(address ucutil.Address) (*walletjson.ValidateAddressWalletResult, error) {
...
func (r FutureListAccountsResult) Receive() (map[string]ucutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	accountsMap := make(map[string]ucutil.Amount)
	for k, v := range accounts {
		amount, err := ucutil.NewAmount(v)
		if err != nil {
			return nil, err
		}
...
func (c *Client) ListAccounts() (map[string]ucutil.Amount, error) {
...
func (c *Client) ListAccountsMinConf(minConfirms int) (map[string]ucutil.Amount, error) {
...
func (r FutureGetReceivedByAccountResult) Receive() (ucutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	amount, err := ucutil.NewAmount(balance)
	if err != nil {
		return 0, err
	}
...
// confirmations.
func (c *Client) GetReceivedByAccount(account string) (ucutil.Amount, error) {
...
func (c *Client) GetReceivedByAccountMinConf(account string, minConfirms int) (ucutil.Amount, error) {
...
func (r FutureGetUnconfirmedBalanceResult) Receive() (ucutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetUnconfirmedBalance(account string) (ucutil.Amount, error) {
...
func (r FutureGetReceivedByAddressResult) Receive() (ucutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetReceivedByAddressAsync(address ucutil.Address) FutureGetReceivedByAddressResult {
	addr := address.Address()
...
// confirmations.
func (c *Client) GetReceivedByAddress(address ucutil.Address) (ucutil.Amount, error) {
...
func (c *Client) GetReceivedByAddressMinConfAsync(address ucutil.Address, minConfirms int) FutureGetReceivedByAddressResult {
	addr := address.Address()
...
func (c *Client) GetReceivedByAddressMinConf(address ucutil.Address, minConfirms int) (ucutil.Amount, error) {
...
func (c *Client) SignMessageAsync(address ucutil.Address, message string) FutureSignMessageResult {
	addr := address.Address()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SignMessage(address ucutil.Address, message string) (string, error) {
...
func (c *Client) VerifyMessageAsync(address ucutil.Address, signature, message string) FutureVerifyMessageResult {
	addr := address.Address()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) VerifyMessage(address ucutil.Address, signature, message string) (bool, error) {
...
// (WIF)
func (r FutureDumpPrivKeyResult) Receive() (*ucutil.WIF, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return ucutil.DecodeWIF(privKeyWIF, ucutil.ActiveNet.PrivateKeyID)
}
...
func (c *Client) DumpPrivKeyAsync(address ucutil.Address) FutureDumpPrivKeyResult {
	addr := address.Address()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) DumpPrivKey(address ucutil.Address) (*ucutil.WIF, error) {
...
func (c *Client) ImportPrivKeyAsync(privKeyWIF *ucutil.WIF) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
...
// format (WIF).
func (c *Client) ImportPrivKey(privKeyWIF *ucutil.WIF) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyLabelAsync(privKeyWIF *ucutil.WIF, label string) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyLabel(privKeyWIF *ucutil.WIF, label string) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyRescanAsync(privKeyWIF *ucutil.WIF, label string, rescan bool) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyRescan(privKeyWIF *ucutil.WIF, label string, rescan bool) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyRescanFromAsync(privKeyWIF *ucutil.WIF, label string, rescan bool, scanFrom int) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyRescanFrom(privKeyWIF *ucutil.WIF, label string, rescan bool, scanFrom int) error {
...
func (c *Client) AddTicket(ticket *ucutil.Tx) error {
...
// NOTE: While getinfo is implemented here (in wallet.go), a ucd chain server
...
func (c *Client) SetTicketFeeAsync(fee ucutil.Amount) FutureSetTicketFeeResult {
	cmd := walletjson.NewSetTicketFeeCmd(fee.ToCoin())
	return c.sendCmd(cmd)
}

// SetTicketFee sets the ticket fee per KB amount.
func (c *Client) SetTicketFee(fee ucutil.Amount) error {
...
func (c *Client) SetTxFeeAsync(fee ucutil.Amount) FutureSetTxFeeResult {
	cmd := walletjson.NewSetTxFeeCmd(fee.ToCoin())
	return c.sendCmd(cmd)
}

// SetTxFee sets the transaction fee per KB amount.
func (c *Client) SetTxFee(fee ucutil.Amount) error {
...
//
// See GetInfo for the blocking version and more details.
func (c *Client) StakePoolUserInfoAsync(addr ucutil.Address) FutureStakePoolUserInfoResult {
...
func (c *Client) StakePoolUserInfo(addr ucutil.Address) (*walletjson.StakePoolUserInfoResult, error) {
...
//
// See GetInfo for the blocking version and more details.
func (c *Client) TicketsForAddressAsync(addr ucutil.Address) FutureTicketsForAddressResult {
...
// owned by the wallet.
func (c *Client) TicketsForAddress(addr ucutil.Address) (*chainjson.TicketsForAddressResult, error) {
...
// backupwallet (NYI in ucwallet)
// encryptwallet (Won't be supported by ucwallet since it's always encrypted)
// getwalletinfo (NYI in ucwallet or ucjson)
// listaddressgroupings (NYI in ucwallet)
// listreceivedbyaccount (NYI in ucwallet)

// DUMP
// importwallet (NYI in ucwallet)
// dumpwallet (NYI in ucwallet)
