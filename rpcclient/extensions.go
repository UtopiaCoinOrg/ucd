...
//
// NOTE: This is a ucwallet extension.
...
// managed by ucwallet are only written to disk with encrypted private keys,
...
// result of the RPC at some future time by invoking the Receive function on the
// returned instance.
func (c *Client) ExistsAddressAsync(address ucutil.Address) FutureExistsAddressResult {
...
//
// NOTE: This is a ucd extension.
func (c *Client) ExistsAddress(address ucutil.Address) (bool, error) {
...
// result of the RPC at some future time by invoking the Receive function on the
// returned instance.
func (c *Client) ExistsAddressesAsync(addresses []ucutil.Address) FutureExistsAddressesResult {
...
//
// NOTE: This is a ucd extension.
func (c *Client) ExistsAddresses(addresses []ucutil.Address) (string, error) {
...
func (c *Client) ExportWatchingWalletAsync(account string) FutureExportWatchingWalletResult {
	cmd := walletjson.NewExportWatchingWalletCmd(&account, ucjson.Bool(true))
	return c.sendCmd(cmd)
}
...
// used by ucwallet to enable a wallet which does not have the private keys
...
// Receive waits for the response promised by the future and returns the network
// the server is running on.
func (r FutureGetTicketPoolValueResult) Receive() (ucutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
//
// NOTE: This is a ucd extension.
func (c *Client) GetTicketPoolValue() (ucutil.Amount, error) {
...
//
// NOTE: This is a ucd extension.
func (c *Client) ListAddressTransactionsAsync(addresses []ucutil.Address, account string) FutureListAddressTransactionsResult {
...
//
// NOTE: This is a ucwallet extension.
func (c *Client) ListAddressTransactions(addresses []ucutil.Address, account string) ([]walletjson.ListTransactionsResult, error) {
...
//
// NOTE: This is a Utopia extension.
...
// Receive waits for the response promised by the future and returns the
// ticketvwap result.
func (r FutureTicketVWAPResult) Receive() (ucutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
//
// NOTE: This is a Utopia extension.
func (c *Client) TicketVWAP(start *uint32, end *uint32) (ucutil.Amount, error) {
