...
type MessageListeners struct {
	...
	OnFlashTx     func(p *Peer, msg *wire.MsgFlashTx)
	OnFlashTxVote func(p *Peer, msg *wire.MsgFlashTxVote)
...
// Peer provides a basic concurrent safe Utopia peer for handling utopia
...
// callbacks for handling Utopia protocol messages.
//
...
// newPeerBase returns a new base Utopia peer based on the inbound flag.  This
...
// NewInboundPeer returns a new inbound Utopia peer. Use Start to begin
// processing incoming and outgoing messages.
func NewInboundPeer(cfg *Config) *Peer {
	return newPeerBase(cfg, true)
}

// NewOutboundPeer returns a new outbound Utopia peer.
