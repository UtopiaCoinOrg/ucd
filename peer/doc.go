...
/*
Package peer provides a common base for creating and managing Utopia network
peers.

Overview

This package builds upon the wire package, which provides the fundamental
primitives necessary to speak the Utopia wire protocol, in order to simplify
...
A quick overview of the major features peer provides are as follows:
 ...
 - Provides a basic concurrent safe Utopia peer for handling utopia
   communications via the peer-to-peer protocol
 - Full duplex reading and writing of Utopia protocol messages
 ...
 - Flexible peer configuration
   ...
   - Ability to register callbacks for handling Utopia protocol messages
...
caller to specify things such as the user agent name and version, the utopia
network to use, which services it supports, and callbacks to invoke when utopia
...
In order to do anything useful with a peer, it is necessary to react to utopia
...
For convenience, a callback hook for all of the currently supported utopia
...
(https://godoc.org/github.com/UtopiaCoinOrg/ucd/wire#hdr-Bitcoin_Improvement_Proposals)
*/
package peer
