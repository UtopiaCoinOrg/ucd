...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://godoc.org/github.com/Utopia/ucd/peer)
...
```bash
$ go get -u github.com/Utopia/ucd/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/Utopia/ucd/peer#example-package--NewOutboundPeer)  
