...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://godoc.org/github.com/UtopiaCoinOrg/ucd/peer)
...
```bash
$ go get -u github.com/UtopiaCoinOrg/ucd/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/UtopiaCoinOrg/ucd/peer#example-package--NewOutboundPeer)  
