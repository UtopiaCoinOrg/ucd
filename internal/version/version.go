...
// for ucd and other utilities provided in the same repository.
package version
...
var (
	...
	// build process with:
	// '-ldflags "-X github.com/UtopiaCoinOrg/ucd/internal/version.PreRelease=foo"'
	...
	// build process with:
	// '-ldflags "-X github.com/UtopiaCoinOrg/ucd/internal/version.BuildMetadata=foo"'
