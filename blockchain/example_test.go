...
// overview documentation describes, this includes all of the Utopia consensus
...
func ExampleBlockChain_ProcessBlock() {
	...
	// exists.
	genesisBlock := ucutil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
...
func ExampleCompactToBig() {
	// Convert the bits from block 300000 in the main Utopia block chain.
