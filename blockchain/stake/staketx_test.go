...
func TestSStx(t *testing.T) {
	var sstx = ucutil.NewTx(sstxMsgTx)
	...
	sstx = ucutil.NewTxDeep(sstxMsgTx)
...
func TestSSTxErrors(t *testing.T) {
	...
	var sstxExtraInputs = ucutil.NewTx(sstxMsgTxExtraInput)
	...
	var sstxExtraOutputs = ucutil.NewTx(sstxMsgTxExtraOutputs)
	...
	var sstxUntaggedOut = ucutil.NewTx(&tx)
	...
	var sstxInsOutsMismatched = ucutil.NewTx(sstxMismatchedInsOuts)
	...
	var sstxBadVerOut = ucutil.NewTx(sstxBadVersionOut)
	...
	var sstxNoNullData = ucutil.NewTx(sstxNullDataMissing)
	...
	var sstxNullDataMis = ucutil.NewTx(sstxNullDataMisplaced)
	...
	var sstxWrongPKHLength = ucutil.NewTx(&tx)
	...
	var sstxWrongPrefix = ucutil.NewTx(&tx)
...
func TestSSGen(t *testing.T) {
	var ssgen = ucutil.NewTx(ssgenMsgTx)
	...
	ssgen = ucutil.NewTxDeep(ssgenMsgTx)
	ssgen.SetTree(wire.TxTreeStake)
	ssgen.SetIndex(0)
...
func TestSSGenErrors(t *testing.T) {
	...
	var ssgenExtraInputs = ucutil.NewTx(ssgenMsgTxExtraInput)
	...
	var ssgenExtraOutputs = ucutil.NewTx(ssgenMsgTxExtraOutputs)
	...
	var ssgenStakeBaseWrong = ucutil.NewTx(ssgenMsgTxStakeBaseWrong)
	...
	var ssgenWrongTreeIns = ucutil.NewTx(&tx)
	...
	// ---------------------------------------------------------------------------
	// Test for bad version of output.
	var ssgenTxBadVerOut = ucutil.NewTx(ssgenMsgTxBadVerOut)
	...
	var ssgenWrongZeroethOut = ucutil.NewTx(ssgenMsgTxWrongZeroethOut)
	...
	var ssgenWrongDataPush0Length = ucutil.NewTx(&tx)
	...
	var ssgenWrongNullData0Prefix = ucutil.NewTx(&tx)
	...
	var ssgenWrongFirstOut = ucutil.NewTx(ssgenMsgTxWrongFirstOut)
	...
	var ssgenWrongDataPush1Length = ucutil.NewTx(&tx)
	...
	var ssgenWrongNullData1Prefix = ucutil.NewTx(&tx)
	...
	var ssgentestGenOutputUntagged = ucutil.NewTx(&tx)
...
func TestSSRtx(t *testing.T) {
	var ssrtx = ucutil.NewTx(ssrtxMsgTx)
...
func TestIsSSRtxErrors(t *testing.T) {
	...
	var ssrtxTooManyInputs = ucutil.NewTx(ssrtxMsgTxTooManyInputs)
	...
	var ssrtxTooManyOutputs = ucutil.NewTx(ssrtxMsgTxTooManyOutputs)
	...
	// ---------------------------------------------------------------------------
	// Test for bad version of output.
	var ssrtxTxBadVerOut = ucutil.NewTx(ssrtxMsgTxBadVerOut)
	...
	var ssrtxTestRevocOutputUntagged = ucutil.NewTx(&tx)
	...
	var ssrtxWrongTreeIns = ucutil.NewTx(&tx)
