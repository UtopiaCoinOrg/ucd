...
// CalcWork calculates a work value from difficulty bits.  Utopia increases
...
// weighted averages.
//
// NOTE: This is the original stake difficulty algorithm that was used at Utopia
// launch.
//
// This function MUST be called with the chain state lock held (for writes).
func (b *BlockChain) calcNextRequiredStakeDifficultyV1(curNode *blockNode) (int64, error) {
	...
	// Utopia parameters, but might do weird things if you use custom
	// parameters.
	if curNode == nil ||
