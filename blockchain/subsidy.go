...
func blockOneCoinbasePaysTokens(tx *ucutil.Tx, params *chaincfg.Params) error {
...
func CoinbasePaysTax(subsidyCache *SubsidyCache, tx *ucutil.Tx, height int64, voters uint16, params *chaincfg.Params) error {
...
func CalculateAddedSubsidy(block, parent *ucutil.Block) int64 {
	var subsidy int64
