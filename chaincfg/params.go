...
// Params defines a Utopia network by its parameters.  These parameters may be
// used by Utopia applications to differentiate networks as well as addresses
...
type Params struct {
	...
	// Ticket pool sizes for Utopia PoS. This denotes the number of possible
	...
	// Average number of tickets per block for Utopia PoS.
