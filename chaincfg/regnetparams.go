// Copyright (c) 2018-2019 The Utopia developers
...
func RegNetParams() *Params {
	// regNetPowLimit is the highest proof of work value a Utopia block
	...
	return &Params{
		...
		WorkDiffWindows:          4,
		TargetTimespan:           time.Second * 2 * 8, // TimePerBlock * WindowSize
		...
		*/
		...
		PubKeyHashAddrID:     [2]byte{0x0d, 0xa0}, // starts with RC
		PKHEdwardsAddrID:     [2]byte{0x0d, 0xe0}, // starts with Re
		PKHSchnorrAddrID:     [2]byte{0x0e, 0x01}, // starts with Rs
		ScriptHashAddrID:     [2]byte{0x0d, 0xf2}, // starts with Rm
		...
		StakeEnabledHeight:      256 + 16,       // CoinbaseMaturity + TicketMaturity
		StakeValidationHeight:   256 + 820, // CoinbaseMaturity + TicketPoolSize*2
