...
func MainNetParams() *Params {
	...
	//
	// The genesis block for Utopia mainnet, testnet, and simnet are not
	...
	return &Params{
		...
		DefaultPort: "10508",
		DNSSeeds: []DNSSeed{
			{"communitynode.utopiacoin.org", true},
			{"mainnetseed.utopiacoin.org", true},
			{"mainnetseed1.utopiacoin.org", true},
			{"mainnetseed2.utopiacoin.org", true},
			{"mainnetseed3.utopiacoin.org", true},
			{"mainnetseed4.utopiacoin.org", true},
			{"mainnetseed5.utopiacoin.org", true},
			{"mainnetseed.utopiacoin.network", true},
			{"mainnetseed.utopiacoin.io", true},
			{"mainnetseed.utopiacoin.org", true},
		},
	...
	/*		{440, newHashFromStr("0000000000002203eb2c95ee96906730bb56b2985e174518f90eb4db29232d93")},
		...
		RuleChangeActivationInterval:   2016 * 4, // 5.6 ay
		...
		NetworkAddressPrefix: "U",
		PubKeyAddrID:         [2]byte{0x2a, 0x80}, // starts with Uk
		PubKeyHashAddrID:     [2]byte{0x0f, 0x50}, // starts with UC
		PKHEdwardsAddrID:     [2]byte{0x0f, 0x91}, // starts with Ue
		PKHSchnorrAddrID:     [2]byte{0x0f, 0xb1}, // starts with Us
		ScriptHashAddrID:     [2]byte{0x0f, 0xa2}, // starts with Um
