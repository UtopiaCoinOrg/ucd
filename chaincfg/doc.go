...
//
// In addition to the main Utopia network, which is intended for the transfer
...
// wire.UtopiaNet using ParamsForNet, but be aware that this usage is
...
//          addr, err := ucutil.NewAddressPubKeyHash(pubKeyHash, chainParams)
//          if err != nil {
//                  log.Fatal(err)
//          }
//          fmt.Println(addr)
//  }
//
// If an application does not use one of the standard Utopia networks, a new
