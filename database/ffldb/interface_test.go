...
// a slice of them.
func loadBlocks(t *testing.T, dataFile string, network wire.CurrencyNet) ([]*ucutil.Block, error) {
	...
	blocks := make([]*ucutil.Block, 169)
	for i := 0; i <= 168; i++ {
		bl, err := ucutil.NewBlockFromBytes(blockChain[int64(i)])
		if err != nil {
