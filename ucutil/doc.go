...
A Block defines a Utopia block that provides easier and more efficient
...
A Tx defines a Utopia transaction that provides more efficient manipulation of
...
The Address interface provides an abstraction for a Utopia address.  While the
most common type is a pay-to-pubkey-hash, Utopia already supports others and
