...
// the tests.  They match the Utopia mainnet params as of the time this comment
// was written.
...
// throughout the tests.  They match the Utopia mainnet params as of the time
		...
		},
		{
			...
			f: func() (Address, error) {
				...
				return NewAddressPubKeyHash(pkHash,
					testNetParams, ucec.STEcdsaSecp256k1)
			},
			net: testNetParams,
		},
		{
