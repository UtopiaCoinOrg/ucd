...
// Copyright (c) 2015 The Utopia developers
...
// units, "1eN UC" is returned, where N is the AmountUnit.
func (u AmountUnit) String() string {
	...
	case AmountAtom:
		return "Atom"
	default:
		return "1e" + strconv.FormatInt(int64(u), 10) + " UC"
	}
}
...
// useful for services that build on top of Utopia (for example, calculating
