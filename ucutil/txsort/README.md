...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://godoc.org/github.com/Utopia/ucd/ucutil/txsort)
...
```bash
$ go get -u github.com/Utopia/ucd/ucutil/txsort
```
