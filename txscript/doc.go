...
utopia transaction scripts.

Script Overview

Utopia transaction scripts are written in a stack-base, FORTH-like language.

The Utopia script language consists of a number of opcodes which fall into
...
The vast majority of Utopia scripts at the time of this writing are of several
...
what conditions must be met in order to spend utopias.
