...
// FileContents is a string containing the commented example config for ucd.
...
; The default is ~/.ucd/data on POSIX OSes, $LOCALAPPDATA/Ucd/data on Windows,
; ~/Library/Application Support/Ucd/data on macOS, and $homed/ucd/data on
; Plan9.  Environment variables are expanded so they may be used.  NOTE: Windows
; environment variables are typically %VARIABLE%, but they must be accessed with
; $VARIABLE here.
; datadir=~/.ucd/data                            ; Unix
; datadir=$LOCALAPPDATA/Ucd/data                 ; Windows
; datadir=~/Library/Application Support/Ucd/data ; macOS
...
; line.  ucd will not contact 3rd-party sites to obtain external ip addresses.
...
; with, but the behavior is slightly different.  By default, ucd will query DNS
...
; addpeer=192.168.1.1
; addpeer=10.0.0.2:10508
; addpeer=fe80::1
; addpeer=[fe80::2]:10508
...
; connect=192.168.1.1
; connect=10.0.0.2:10508
; connect=fe80::1
; connect=[fe80::2]:10508
...
; Disable DNS seeding for peers.  By default, when ucd starts, it will use
...
;   listen=::
; All interfaces on port 10508:
;   listen=:10508
; All ipv4 interfaces on port 10508:
;   listen=0.0.0.0:10508
; All ipv6 interfaces on port 10508:
;   listen=[::]:10508
; Only ipv4 localhost on port 10508:
;   listen=127.0.0.1:10508
; Only ipv6 localhost on port 10508:
;   listen=[::1]:10508
...
; which is used to control and query information from a running ucd process.
;
...
; All ipv6 interfaces on default port:
;   rpclisten=::
; All interfaces on port 10509:
;   rpclisten=:10509
; All ipv4 interfaces on port 10509:
;   rpclisten=0.0.0.0:10509
; All ipv6 interfaces on port 10509:
;   rpclisten=[::]:10509
; Only ipv4 localhost on port 10509:
;   rpclisten=127.0.0.1:10509
; Only ipv6 localhost on port 10509:
;   rpclisten=[::1]:10509
...
; log level for individual subsystems.  Use ucd --debuglevel=show to list
