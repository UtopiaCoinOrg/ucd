...
// transaction hash and output number pair. Contains Utopia additions.
...
type CreateRawTransactionCmd struct {
	Inputs   []TransactionInput
	Amounts  map[string]float64 `jsonrpcusage:"{\"address\":amount,...}"` // In UC
	LockTime *int64
	Expiry   *int64
}
...
func convertTemplateRequestField(fieldName string, iface interface{}) (interface{}, error) {
	...
	return nil, ucjson.Error{Code: ucjson.ErrInvalidType, Message: str}
}
...
func init() {
	...
	flags := ucjson.UsageFlag(0)

	ucjson.MustRegister(Method("addnode"), (*AddNodeCmd)(nil), flags)
	ucjson.MustRegister(Method("createrawssrtx"), (*CreateRawSSRtxCmd)(nil), flags)
	ucjson.MustRegister(Method("createrawsstx"), (*CreateRawSStxCmd)(nil), flags)
	ucjson.MustRegister(Method("createrawtransaction"), (*CreateRawTransactionCmd)(nil), flags)
	ucjson.MustRegister(Method("debuglevel"), (*DebugLevelCmd)(nil), flags)
	ucjson.MustRegister(Method("decoderawtransaction"), (*DecodeRawTransactionCmd)(nil), flags)
	ucjson.MustRegister(Method("decodescript"), (*DecodeScriptCmd)(nil), flags)
	ucjson.MustRegister(Method("estimatefee"), (*EstimateFeeCmd)(nil), flags)
	ucjson.MustRegister(Method("estimatesmartfee"), (*EstimateSmartFeeCmd)(nil), flags)
	ucjson.MustRegister(Method("estimatestakediff"), (*EstimateStakeDiffCmd)(nil), flags)
	ucjson.MustRegister(Method("existsaddress"), (*ExistsAddressCmd)(nil), flags)
	ucjson.MustRegister(Method("existsaddresses"), (*ExistsAddressesCmd)(nil), flags)
	ucjson.MustRegister(Method("existsmissedtickets"), (*ExistsMissedTicketsCmd)(nil), flags)
	ucjson.MustRegister(Method("existsexpiredtickets"), (*ExistsExpiredTicketsCmd)(nil), flags)
	ucjson.MustRegister(Method("existsliveticket"), (*ExistsLiveTicketCmd)(nil), flags)
	ucjson.MustRegister(Method("existslivetickets"), (*ExistsLiveTicketsCmd)(nil), flags)
	ucjson.MustRegister(Method("existsmempooltxs"), (*ExistsMempoolTxsCmd)(nil), flags)
	ucjson.MustRegister(Method("generate"), (*GenerateCmd)(nil), flags)
	ucjson.MustRegister(Method("getaddednodeinfo"), (*GetAddedNodeInfoCmd)(nil), flags)
	ucjson.MustRegister(Method("getbestblock"), (*GetBestBlockCmd)(nil), flags)
	ucjson.MustRegister(Method("getbestblockhash"), (*GetBestBlockHashCmd)(nil), flags)
	ucjson.MustRegister(Method("getblock"), (*GetBlockCmd)(nil), flags)
	ucjson.MustRegister(Method("getblockchaininfo"), (*GetBlockChainInfoCmd)(nil), flags)
	ucjson.MustRegister(Method("getblockcount"), (*GetBlockCountCmd)(nil), flags)
	ucjson.MustRegister(Method("getblockhash"), (*GetBlockHashCmd)(nil), flags)
	ucjson.MustRegister(Method("getblockheader"), (*GetBlockHeaderCmd)(nil), flags)
	ucjson.MustRegister(Method("getblocksubsidy"), (*GetBlockSubsidyCmd)(nil), flags)
	ucjson.MustRegister(Method("getblocktemplate"), (*GetBlockTemplateCmd)(nil), flags)
	ucjson.MustRegister(Method("getcfilter"), (*GetCFilterCmd)(nil), flags)
	ucjson.MustRegister(Method("getcfilterheader"), (*GetCFilterHeaderCmd)(nil), flags)
	ucjson.MustRegister(Method("getchaintips"), (*GetChainTipsCmd)(nil), flags)
	ucjson.MustRegister(Method("getcoinsupply"), (*GetCoinSupplyCmd)(nil), flags)
	ucjson.MustRegister(Method("getconnectioncount"), (*GetConnectionCountCmd)(nil), flags)
	ucjson.MustRegister(Method("getcurrentnet"), (*GetCurrentNetCmd)(nil), flags)
	ucjson.MustRegister(Method("getdifficulty"), (*GetDifficultyCmd)(nil), flags)
	ucjson.MustRegister(Method("getgenerate"), (*GetGenerateCmd)(nil), flags)
	ucjson.MustRegister(Method("gethashespersec"), (*GetHashesPerSecCmd)(nil), flags)
	ucjson.MustRegister(Method("getheaders"), (*GetHeadersCmd)(nil), flags)
	ucjson.MustRegister(Method("getinfo"), (*GetInfoCmd)(nil), flags)
	ucjson.MustRegister(Method("getmempoolinfo"), (*GetMempoolInfoCmd)(nil), flags)
	ucjson.MustRegister(Method("getmininginfo"), (*GetMiningInfoCmd)(nil), flags)
	ucjson.MustRegister(Method("getnetworkinfo"), (*GetNetworkInfoCmd)(nil), flags)
	ucjson.MustRegister(Method("getnettotals"), (*GetNetTotalsCmd)(nil), flags)
	...
	ucjson.MustRegister(Method("getstakeversions"), (*GetStakeVersionsCmd)(nil), flags)
	ucjson.MustRegister(Method("getticketpoolvalue"), (*GetTicketPoolValueCmd)(nil), flags)
	ucjson.MustRegister(Method("gettxout"), (*GetTxOutCmd)(nil), flags)
	ucjson.MustRegister(Method("gettxoutsetinfo"), (*GetTxOutSetInfoCmd)(nil), flags)
	ucjson.MustRegister(Method("getvoteinfo"), (*GetVoteInfoCmd)(nil), flags)
	ucjson.MustRegister(Method("getwork"), (*GetWorkCmd)(nil), flags)
	ucjson.MustRegister(Method("help"), (*HelpCmd)(nil), flags)
	ucjson.MustRegister(Method("livetickets"), (*LiveTicketsCmd)(nil), flags)
	ucjson.MustRegister(Method("missedtickets"), (*MissedTicketsCmd)(nil), flags)
	ucjson.MustRegister(Method("node"), (*NodeCmd)(nil), flags)
	ucjson.MustRegister(Method("ping"), (*PingCmd)(nil), flags)
	ucjson.MustRegister(Method("rebroadcastmissed"), (*RebroadcastMissedCmd)(nil), flags)
	...
	ucjson.MustRegister(Method("ticketfeeinfo"), (*TicketFeeInfoCmd)(nil), flags)
	ucjson.MustRegister(Method("ticketsforaddress"), (*TicketsForAddressCmd)(nil), flags)
	ucjson.MustRegister(Method("ticketvwap"), (*TicketVWAPCmd)(nil), flags)
	ucjson.MustRegister(Method("txfeeinfo"), (*TxFeeInfoCmd)(nil), flags)
	ucjson.MustRegister(Method("validateaddress"), (*ValidateAddressCmd)(nil), flags)
	ucjson.MustRegister(Method("verifychain"), (*VerifyChainCmd)(nil), flags)
	ucjson.MustRegister(Method("verifymessage"), (*VerifyMessageCmd)(nil), flags)
	ucjson.MustRegister(Method("version"), (*VersionCmd)(nil), flags)
}
