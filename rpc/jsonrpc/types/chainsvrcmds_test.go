...
// Copyright (c) 2016-2019 The Utopia developers
...
import (
	...
	"github.com/Utopia/ucd/ucjson/v3"
)
...
func TestChainSvrCmds(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name: "addnode",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("addnode"), "127.0.0.1", ANRemove)
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("createrawtransaction"), `[{"amount":0.0123,"txid":"123","vout":1}]`,
					`{"456":0.0123}`)
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("createrawtransaction"), `[{"amount":0.0123,"txid":"123","vout":1,"tree":0}]`,
			...
			staticCmd: func() interface{} {
				...
				amounts := map[string]float64{"456": .0123}
				return NewCreateRawTransactionCmd(txInputs, amounts, ucjson.Int64(12312333333), ucjson.Int64(12312333333))
			},
			...
			unmarshalled: &CreateRawTransactionCmd{
				Inputs:   []TransactionInput{{Amount: 0.0123, Txid: "123", Vout: 1}},
				Amounts:  map[string]float64{"456": .0123},
				LockTime: ucjson.Int64(12312333333),
				Expiry:   ucjson.Int64(12312333333),
			},
		},
		{
			name: "debuglevel",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("debuglevel"), "trace")
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("decoderawtransaction"), "123")
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "decodescript",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("decodescript"), "00")
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("decodescript"), "00", ucjson.Uint16(1))
			},
			staticCmd: func() interface{} {
				cmd := NewDecodeScriptCmd("00")
				cmd.Version = ucjson.Uint16(1)
				return cmd
			},
			marshalled:   `{"jsonrpc":"1.0","method":"decodescript","params":["00",1],"id":1}`,
			unmarshalled: &DecodeScriptCmd{HexScript: "00", Version: ucjson.Uint16(1)},
		},
		{
			name: "estimatefee",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("estimatefee"), 6)
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("estimatesmartfee"), 6)
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("estimatesmartfee"), 6, EstimateSmartFeeConservative)
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "generate",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("generate"), 1)
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("getaddednodeinfo"), true)
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("getaddednodeinfo"), true, "127.0.0.1")
			},
			staticCmd: func() interface{} {
				return NewGetAddedNodeInfoCmd(true, ucjson.String("127.0.0.1"))
			},
			marshalled: `{"jsonrpc":"1.0","method":"getaddednodeinfo","params":[true,"127.0.0.1"],"id":1}`,
			unmarshalled: &GetAddedNodeInfoCmd{
				DNS:  true,
				Node: ucjson.String("127.0.0.1"),
			},
		},
		{
			name: "getbestblock",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("getbestblock"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("getbestblockhash"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "getblock",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("getblock"), "123")
			},
			staticCmd: func() interface{} {
			...
			unmarshalled: &GetBlockCmd{
				Hash:      "123",
				Verbose:   ucjson.Bool(true),
				VerboseTx: ucjson.Bool(false),
			},
		},
		{
			...
			newCmd: func() (interface{}, error) {
				...
				// exercise that path.
				verbosePtr := ucjson.Bool(true)
				return ucjson.NewCmd(Method("getblock"), "123", &verbosePtr)
			},
			staticCmd: func() interface{} {
				return NewGetBlockCmd("123", ucjson.Bool(true), nil)
			},
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("getblock"), "123", true, true)
			},
			staticCmd: func() interface{} {
				return NewGetBlockCmd("123", ucjson.Bool(true), ucjson.Bool(true))
			},
			marshalled: `{"jsonrpc":"1.0","method":"getblock","params":["123",true,true],"id":1}`,
			unmarshalled: &GetBlockCmd{
				Hash:      "123",
				Verbose:   ucjson.Bool(true),
				VerboseTx: ucjson.Bool(true),
			},
		},
		{
			name: "getblockchaininfo",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("getblockchaininfo"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "getblockcount",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("getblockcount"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "getblockhash",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("getblockhash"), 123)
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "getblockheader",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("getblockheader"), "123")
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("getblocksubsidy"), 123, 256)
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("getblocktemplate"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("getblocktemplate"), `{"mode":"template","capabilities":["longpoll","coinbasetxn"]}`)
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("getblocktemplate"), `{"mode":"template","capabilities":["longpoll","coinbasetxn"],"sigoplimit":500,"sizelimit":100000000,"maxversion":2}`)
			},
			staticCmd: func() interface{} {
				template := TemplateRequest{
					Mode:         "template",
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("getblocktemplate"), `{"mode":"template","capabilities":["longpoll","coinbasetxn"],"sigoplimit":true,"sizelimit":100000000,"maxversion":2}`)
			},
			staticCmd: func() interface{} {
				template := TemplateRequest{
					Mode:         "template",
		...
		},
		{
			name: "getcfilter",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("getcfilter"), "123", "extended")
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("getcfilterheader"), "123", "extended")
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "getchaintips",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("getchaintips"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("getconnectioncount"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "getcurrentnet",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("getcurrentnet"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "getdifficulty",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("getdifficulty"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "getgenerate",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("getgenerate"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("gethashespersec"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "getinfo",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("getinfo"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "getmempoolinfo",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("getmempoolinfo"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "getmininginfo",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("getmininginfo"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "getnetworkinfo",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("getnetworkinfo"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "getnettotals",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("getnettotals"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("getnetworkhashps"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("getnetworkhashps"), 200)
			},
			staticCmd: func() interface{} {
				return NewGetNetworkHashPSCmd(ucjson.Int(200), nil)
			},
			marshalled: `{"jsonrpc":"1.0","method":"getnetworkhashps","params":[200],"id":1}`,
			unmarshalled: &GetNetworkHashPSCmd{
				Blocks: ucjson.Int(200),
				Height: ucjson.Int(-1),
			},
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("getnetworkhashps"), 200, 123)
			},
			staticCmd: func() interface{} {
				return NewGetNetworkHashPSCmd(ucjson.Int(200), ucjson.Int(123))
			},
			marshalled: `{"jsonrpc":"1.0","method":"getnetworkhashps","params":[200,123],"id":1}`,
			unmarshalled: &GetNetworkHashPSCmd{
				Blocks: ucjson.Int(200),
				Height: ucjson.Int(123),
			},
		},
		{
			name: "getpeerinfo",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("getpeerinfo"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "getrawmempool",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("getrawmempool"))
			},
			staticCmd: func() interface{} {
			...
			unmarshalled: &GetRawMempoolCmd{
				Verbose: ucjson.Bool(false),
			},
		},
		{
			name: "getrawmempool optional",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("getrawmempool"), false)
			},
			staticCmd: func() interface{} {
				return NewGetRawMempoolCmd(ucjson.Bool(false), nil)
			},
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("getrawmempool"), false, "all")
			},
			staticCmd: func() interface{} {
				return NewGetRawMempoolCmd(ucjson.Bool(false), ucjson.String("all"))
			},
			marshalled: `{"jsonrpc":"1.0","method":"getrawmempool","params":[false,"all"],"id":1}`,
			unmarshalled: &GetRawMempoolCmd{
				Verbose: ucjson.Bool(false),
				TxType:  ucjson.String("all"),
			},
		},
		{
			name: "getrawtransaction",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("getrawtransaction"), "123")
			},
			staticCmd: func() interface{} {
			...
			unmarshalled: &GetRawTransactionCmd{
				Txid:    "123",
				Verbose: ucjson.Int(0),
			},
		},
		{
			name: "getrawtransaction optional",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("getrawtransaction"), "123", 1)
			},
			staticCmd: func() interface{} {
				return NewGetRawTransactionCmd("123", ucjson.Int(1))
			},
			marshalled: `{"jsonrpc":"1.0","method":"getrawtransaction","params":["123",1],"id":1}`,
			unmarshalled: &GetRawTransactionCmd{
				Txid:    "123",
				Verbose: ucjson.Int(1),
			},
		},
		{
			name: "getstakeversions",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("getstakeversions"), "deadbeef", 1)
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "gettxout",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("gettxout"), "123", 1)
			},
			staticCmd: func() interface{} {
			...
			unmarshalled: &GetTxOutCmd{
				Txid:           "123",
				Vout:           1,
				IncludeMempool: ucjson.Bool(true),
			},
		},
		{
			name: "gettxout optional",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("gettxout"), "123", 1, true)
			},
			staticCmd: func() interface{} {
				return NewGetTxOutCmd("123", 1, ucjson.Bool(true))
			},
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("gettxoutsetinfo"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "getvoteinfo",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("getvoteinfo"), 1)
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "getwork",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("getwork"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("getwork"), "00112233")
			},
			staticCmd: func() interface{} {
				return NewGetWorkCmd(ucjson.String("00112233"))
			},
			marshalled: `{"jsonrpc":"1.0","method":"getwork","params":["00112233"],"id":1}`,
			unmarshalled: &GetWorkCmd{
				Data: ucjson.String("00112233"),
			},
		},
		{
			name: "help",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("help"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "help optional",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("help"), "getblock")
			},
			staticCmd: func() interface{} {
				return NewHelpCmd(ucjson.String("getblock"))
			},
			marshalled: `{"jsonrpc":"1.0","method":"help","params":["getblock"],"id":1}`,
			unmarshalled: &HelpCmd{
				Command: ucjson.String("getblock"),
			},
		},
		{
			name: "node option remove",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("node"), NRemove, "1.1.1.1")
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("node"), NDisconnect, "1.1.1.1")
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("node"), NConnect, "1.1.1.1", "perm")
			},
			staticCmd: func() interface{} {
				return NewNodeCmd("connect", "1.1.1.1", ucjson.String("perm"))
			},
			marshalled: `{"jsonrpc":"1.0","method":"node","params":["connect","1.1.1.1","perm"],"id":1}`,
			unmarshalled: &NodeCmd{
				SubCmd:        NConnect,
				Target:        "1.1.1.1",
				ConnectSubCmd: ucjson.String("perm"),
			},
		},
		{
			name: "ping",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("ping"))
			},
			staticCmd: func() interface{} {
				return NewPingCmd()
			},
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("searchrawtransactions"), "1Address")
			},
			staticCmd: func() interface{} {
			...
			unmarshalled: &SearchRawTransactionsCmd{
				...
				Verbose:     ucjson.Int(1),
				Skip:        ucjson.Int(0),
				Count:       ucjson.Int(100),
				VinExtra:    ucjson.Int(0),
				Reverse:     ucjson.Bool(false),
				FilterAddrs: nil,
			},
		},
		{
			name: "searchrawtransactions",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("searchrawtransactions"), "1Address", 0)
			},
			staticCmd: func() interface{} {
				return NewSearchRawTransactionsCmd("1Address",
					ucjson.Int(0), nil, nil, nil, nil, nil)
			},
		...
		},
		{
			name: "searchrawtransactions",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("searchrawtransactions"), "1Address", 0, 5)
			},
			staticCmd: func() interface{} {
				return NewSearchRawTransactionsCmd("1Address",
					ucjson.Int(0), ucjson.Int(5), nil, nil, nil, nil)
			},
		...
		},
		{
			name: "searchrawtransactions",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("searchrawtransactions"), "1Address", 0, 5, 10)
			},
			staticCmd: func() interface{} {
				return NewSearchRawTransactionsCmd("1Address",
					ucjson.Int(0), ucjson.Int(5), ucjson.Int(10), nil, nil, nil)
			},
		...
		},
		{
			name: "searchrawtransactions",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("searchrawtransactions"), "1Address", 0, 5, 10, 1)
			},
			staticCmd: func() interface{} {
				return NewSearchRawTransactionsCmd("1Address",
					ucjson.Int(0), ucjson.Int(5), ucjson.Int(10), ucjson.Int(1), nil, nil)
			},
		...
		},
		{
			name: "searchrawtransactions",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("searchrawtransactions"), "1Address", 0, 5, 10, 1, true)
			},
			staticCmd: func() interface{} {
				return NewSearchRawTransactionsCmd("1Address",
					ucjson.Int(0), ucjson.Int(5), ucjson.Int(10),
					ucjson.Int(1), ucjson.Bool(true), nil)
			},
		...
		},
		{
			name: "searchrawtransactions",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("searchrawtransactions"), "1Address", 0, 5, 10, 1, true, []string{"1Address"})
			},
			staticCmd: func() interface{} {
				return NewSearchRawTransactionsCmd("1Address",
					ucjson.Int(0), ucjson.Int(5), ucjson.Int(10),
					ucjson.Int(1), ucjson.Bool(true), &[]string{"1Address"})
			},
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("sendrawtransaction"), "1122")
			},
			staticCmd: func() interface{} {
			...
			unmarshalled: &SendRawTransactionCmd{
				HexTx:         "1122",
				AllowHighFees: ucjson.Bool(false),
			},
		},
		{
			name: "sendrawtransaction optional",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("sendrawtransaction"), "1122", false)
			},
			staticCmd: func() interface{} {
				return NewSendRawTransactionCmd("1122", ucjson.Bool(false))
			},
		...
		},
		{
			name: "setgenerate",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("setgenerate"), true)
			},
			staticCmd: func() interface{} {
			...
			unmarshalled: &SetGenerateCmd{
				Generate:     true,
				GenProcLimit: ucjson.Int(-1),
			},
		},
		{
			name: "setgenerate optional",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("setgenerate"), true, 6)
			},
			staticCmd: func() interface{} {
				return NewSetGenerateCmd(true, ucjson.Int(6))
			},
			marshalled: `{"jsonrpc":"1.0","method":"setgenerate","params":[true,6],"id":1}`,
			unmarshalled: &SetGenerateCmd{
				Generate:     true,
				GenProcLimit: ucjson.Int(6),
			},
		},
		{
			name: "stop",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("stop"))
			},
			staticCmd: func() interface{} {
				return NewStopCmd()
			},
		...
		},
		{
			name: "submitblock",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("submitblock"), "112233")
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("submitblock"), "112233", `{"workid":"12345"}`)
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("validateaddress"), "1Address")
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "verifychain",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("verifychain"))
			},
			staticCmd: func() interface{} {
			...
			unmarshalled: &VerifyChainCmd{
				CheckLevel: ucjson.Int64(3),
				CheckDepth: ucjson.Int64(288),
			},
		},
		{
			name: "verifychain optional1",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("verifychain"), 2)
			},
			staticCmd: func() interface{} {
				return NewVerifyChainCmd(ucjson.Int64(2), nil)
			},
			marshalled: `{"jsonrpc":"1.0","method":"verifychain","params":[2],"id":1}`,
			unmarshalled: &VerifyChainCmd{
				CheckLevel: ucjson.Int64(2),
				CheckDepth: ucjson.Int64(288),
			},
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("verifychain"), 2, 500)
			},
			staticCmd: func() interface{} {
				return NewVerifyChainCmd(ucjson.Int64(2), ucjson.Int64(500))
			},
			marshalled: `{"jsonrpc":"1.0","method":"verifychain","params":[2,500],"id":1}`,
			unmarshalled: &VerifyChainCmd{
				CheckLevel: ucjson.Int64(2),
				CheckDepth: ucjson.Int64(500),
			},
		},
		{
			name: "verifymessage",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd(Method("verifymessage"), "1Address", "301234", "test")
			},
			staticCmd: func() interface{} {
	...
	for i, test := range tests {
		...
		cmd, err = ucjson.ParseParams(Method(request.Method), request.Params)
		if err != nil {
...
func TestChainSvrCmdErrors(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			err:        ucjson.Error{Code: ucjson.ErrInvalidType},
		},
		{
	...
	for i, test := range tests {
		...
		if terr, ok := test.err.(ucjson.Error); ok {
			gotErrorCode := err.(ucjson.Error).Code
