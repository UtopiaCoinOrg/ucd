...
// from JSON.  Contains Utopia addition.
...
func init() {
	...
	flags := ucjson.UFWebsocketOnly

	ucjson.MustRegister(Method("authenticate"), (*AuthenticateCmd)(nil), flags)
	ucjson.MustRegister(Method("loadtxfilter"), (*LoadTxFilterCmd)(nil), flags)
	ucjson.MustRegister(Method("notifyblocks"), (*NotifyBlocksCmd)(nil), flags)
	ucjson.MustRegister(Method("notifynewtransactions"), (*NotifyNewTransactionsCmd)(nil), flags)
	ucjson.MustRegister(Method("notifynewtickets"), (*NotifyNewTicketsCmd)(nil), flags)
	ucjson.MustRegister(Method("notifyspentandmissedtickets"),
		(*NotifySpentAndMissedTicketsCmd)(nil), flags)
	ucjson.MustRegister(Method("notifystakedifficulty"),
	...
	ucjson.MustRegister(Method("rescan"), (*RescanCmd)(nil), flags)
}
