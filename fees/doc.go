...
Although it was primarily written for ucd, this package has intentionally been
...
second layer alternatives, etc). Also, the current fill rate of blocks in utopia
...
out earlier should be sufficient for current fill rate of utopia's network.
...
[5] Source for the original ucfeesim and estimator work:
https://github.com/matheusd/ucfeesim_dev

[6] Source for the current ucfeesim, using this module:
https://github.com/matheusd/ucfeesim
*/
package fees
